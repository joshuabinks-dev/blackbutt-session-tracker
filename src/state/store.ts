...
function defaultData(): Pick<AppState, 'athletes'|'groups'|'blocks'|'recoveries'|'templates'> {
  ...
  const athletes: AthleteDef[] = [
    ...
    { athleteId: 'russell_taylor', firstName: 'Russell', lastName: 'Taylor', defaultGroupId: 'A' },
    { athleteId: 'amelia_harkness', firstName: 'Amelia', lastName: 'Harkness', defaultGroupId: 'A' },
    ...
    { athleteId: 'cate_giason', firstName: 'Cate', lastName: 'Giason', defaultGroupId: 'B' },
    { athleteId: 'peter_maskiell', firstName: 'Peter', lastName: 'Maskiell', defaultGroupId: 'B' },
  ]
