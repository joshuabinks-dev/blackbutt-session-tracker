      ...
      <div className="card">
        ...
        {recent.length === 0 ? <div className="muted small">None yet.</div> : recent.map(s => (
          <div className="item" key={s.id}>
            ...
            <div className="row" style={{ marginTop: 10 }}>
              <button className="btn" onClick={() => api.resumeSession(s.id)}>View</button>
